...
public class AuthCookieUtil {
    public static void writeAuthCookies(HttpServletResponse res, String at, String rt, boolean secure) {
        ...
        add(res, "AT", at, Duration.ofDays(365), secure, sameSite);
        add(res, "RT", rt, Duration.ofDays(365), secure, sameSite);
    }
    /**
    ...
    public static void clearAuthCookies(HttpServletResponse res, boolean secure) {
        String sameSite = secure ? "None" : "Lax";
        add(res, "AT", "", Duration.ZERO, secure, sameSite);
        add(res, "RT", "", Duration.ZERO, secure, sameSite);
    }
