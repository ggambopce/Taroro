...
import com.neocompany.taroro.domain.admin.docs.AdminTaroCardControllerDocs;
...
@RestController
@RequestMapping("/api/admin/taro-cards")
@RequiredArgsConstructor
public class AdminTaroCardController implements AdminTaroCardControllerDocs {
